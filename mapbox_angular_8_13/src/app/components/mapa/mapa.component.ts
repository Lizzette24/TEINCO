...
export class MapaComponent implements OnInit {
  ...
  escucharSockets() {
    ...
    .subscribe((marcador: Lugar)=> this.markersMapbox[marcador.id].setLngLat([marcador.lng, marcador.lat]));
  ...
  crearMapa() {
    ...
    (mapboxgl as any).accessToken = 'pk.eyJ1IjoiY2VzYXJsb3BleiIsImEiOiJjbDJmMGR6ZzEwNXp4M2NtYzdldG1rMjExIn0.QOIiqn-TCifuv5QsmnHMkA';
